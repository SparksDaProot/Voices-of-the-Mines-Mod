...
public enum SignalType {
    ...
    DNOOSE("dnoose", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_DNOOSE::get),
    WOOSHES("wooshes", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_WOOSHES::get),
    CRISPS("crisps", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_CRISPS::get),
    GARGLE("gargle", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_GARGLE::get),
    HISSES("hisses", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_HISSES::get),
    BASSER("basser", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_BASSER::get),
    SHIFFLER("shiffler", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_SHIFFLER::get),
    BIRBIES("birbies", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_BIRBIES::get),
    WOO("woo", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_WOO::get),
    FLESH("flesh", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_FLESH::get),
    CORPSE("corpse", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGNAL_CORPSE::get),
    ASTEROID("asteroid", "unid_object", Rarity.COMMON, Tex.SHEET, Check.NOISE, null, () -> {
    ...
    METTUS("mettus", "unid_object", Rarity.COMMON, Tex.GENSTARS, Check.UNIQUE, null, VotmSounds.SIGNAL_METTUS::get),
    WHITE_DWARF("white_dwarf", "star", Rarity.COMMON, Tex.STATIC_CAL, Check.NOISE, null, VotmSounds.SIGNAL_WHITEDWARF::get),
    RED_DWARF("red_dwarf", "star", Rarity.COMMON, Tex.SHEET, Check.NOISE, null, VotmSounds.SIGNAL_RED_DWARF::get),
    RED_GIANT("red_giant", "star", Rarity.COMMON, Tex.SHEET, Check.NOISE, null, VotmSounds.SIGNAL_RED_GIANT::get),
    BROWN_DWARF("brown_dwarf", "star", Rarity.COMMON, Tex.SHEET, Check.NOISE, null, VotmSounds.SIGNAL_BROWN_DWARF::get),
    COMET("comet", "comet", Rarity.COMMON, Tex.SHEET, Check.NOISE, null, VotmSounds.SIGNAL_COMET::get),
    ...
    // RARE
    POEM("poem", "unid_object", Rarity.RARE, Tex.GENSTARS, Check.UNIQUE, null, VotmSounds.SIGNAL_POEM::get),
    HA("ha", "unid_object", Rarity.RARE, Tex.GENSTARS, Check.NOISE, "hahaha\nhaha...\nha.", VotmSounds.SIGNAL_HA::get),
    SIGGEN1("siggen1", "unid_planet", Rarity.RARE, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGGEN1::get),
    SIGGEN2("siggen2", "unid_planet", Rarity.RARE, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGGEN2::get),
    SIGGEN3("siggen3", "unid_planet", Rarity.RARE, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGGEN3::get),
    SIGGEN4("siggen4", "unid_planet", Rarity.RARE, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGGEN4::get),
    SIGGEN5("siggen5", "unid_planet", Rarity.RARE, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGGEN5::get),
    SIGGEN6("siggen6", "unid_planet", Rarity.RARE, Tex.GENSTARS, Check.NOISE, null, VotmSounds.SIGGEN6::get),
    EARTH("earth", "planet_earth", Rarity.RARE, Tex.SHEET, Check.NOISE, null, VotmSounds.SIGNAL_PLANET_EARTH::get),
    OBSERVER("observer", "planet_observe", Rarity.RARE, Tex.SHEET, Check.NOISE, "I AM\nWATCHING", VotmSounds.SIGNAL_OBSERVER::get),
    OVALIUS("ovalius", "planet_ovalius", Rarity.RARE, Tex.SHEET, Check.NOISE, null, VotmSounds.SIGNAL_OVALIUS::get),
    COFFIN("coffin", "unid_object", Rarity.RARE, Tex.SHEET, Check.NOISE, null, VotmSounds.SIGNAL_COFFIN::get),
    EXOGEN1("exogen1", "unid_object", Rarity.RARE, Tex.GENSTARS, Check.NOISE, null, VotmSounds.EXOGEN1::get),
    EXOGEN2("exogen2", "unid_object", Rarity.RARE, Tex.GENSTARS, Check.NOISE, null, VotmSounds.EXOGEN2::get),
    ...
    MONTY("monty", "unid_object", Rarity.RARE, Tex.GENSTARS, Check.UNIQUE, "...come here...", VotmSounds.SIGNAL_MONTY::get),
    SAT1("sat1", "unid_object", Rarity.RARE, Tex.GENSTARS, Check.UNIQUE, null, VotmSounds.SIGNAL_SAT1::get),
    HATEFULSTAR("hatefulstar", "star", Rarity.RARE, Tex.STATIC_CAL, Check.UNIQUE, "1548_EX\n[REDACTED]", VotmSounds.SIGNAL_HATEFULSTAR::get),

    // RARER
    AAA("aaa", "unid_object", Rarity.RARER, Tex.GENSTARS, Check.UNIQUE, "AAA\nAAAAA\nA", VotmSounds.SIGNAL_AAA::get),
    KER("ker", "unid_object", Rarity.RARER, Tex.GENSTARS, Check.UNIQUE, null, VotmSounds.SIGNAL_KER::get),
    FACES("faces", "unid_planet", Rarity.RARER, Tex.FACES, Check.NOISE, null, VotmSounds.SIGNAL_FACES::get),
    RETROPLANET("retroplanet", "planet_retro", Rarity.RARER, Tex.RETRO_SHEET, Check.NOISE, "play with me\nI'm coming\nwait\nfor me\n\n              :)", VotmSounds.SIGNAL_PLANET_RETRO::get),
    VOTV_EARTH("votv_earth", "planet_votv_earth", Rarity.RARER, Tex.SHEET, Check.NOISE, "M R \nD R \nN O S E  :D", VotmSounds.VOTV_EARTH::get),
    UAP("uap", "UAP", Rarity.RARER, Tex.SHEET, Check.NOISE, "W.O.W", VotmSounds.SIGNAL_UAP::get),
    MREOWS("mreows", "planet_mreows", Rarity.RARER, Tex.SHEET, Check.NOISE, null, VotmSounds.SIGNAL_MREOWS::get),
    HAIRY("hairy", "unid_planet", Rarity.RARER, Tex.GENSTARS, Check.HAIRY, null, VotmSounds.SIGNAL_HAIRY::get),
    ROZ0("roz0", "unid_object", Rarity.RARER, Tex.GENSTARS, Check.UNIQUE, null, VotmSounds.SIGNAL_ROZ0::get),
    ...
    NEV("nev", "unid_object", Rarity.RARER, Tex.GENSTARS, Check.NOISE, "Hoborg thought this world would make him happy.\n #ut it make him - sad. #alking around his b#g, \n*#eau#iful* new wor#d make h#m feel #l# alone.", VotmSounds.SIGNAL_NEV::get),
    NIKO("niko", "unid_object", Rarity.RARER, Tex.GENSTARS, Check.NOISE, "my burden is light", VotmSounds.SIGNAL_NIKO::get),
    TULPAR("tulpar", "unid_object", Rarity.RARER, Tex.STATIC_CAL, Check.UNIQUE, ". . . .\n.\n. - . .\n. - - .", VotmSounds.SIGNAL_TULPAR::get),

    // VERY RARE
    ARZY("arzy", "unid_object", Rarity.VERY_RARE, Tex.GENSTARS, Check.UNIQUE, "(◐ ω ◑)", VotmSounds.SIGNAL_ARZY::get),
    FUNNY("funny", "unid_object", Rarity.VERY_RARE, Tex.GENSTARS, Check.UNIQUE, "YOU\nARE\nVERY\nLUCKY", VotmSounds.SIGNAL_FUNNY::get),
    SIGGENUS1("siggenus1", "unid_planet", Rarity.VERY_RARE, Tex.GENSTARS, Check.ID_PNG, null, VotmSounds.SIGNAL_SIGGENUS1::get),
    SIGGENUS2("siggenus2", "unid_planet", Rarity.VERY_RARE, Tex.GENSTARS, Check.ID_PNG, null, VotmSounds.SIGNAL_SIGGENUS2::get),
    SIGGENUS3("siggenus3", "unid_planet", Rarity.VERY_RARE, Tex.GENSTARS, Check.ID_PNG, null, VotmSounds.SIGNAL_SIGGENUS3::get),
    SIGGENUS4("siggenus4", "unid_planet", Rarity.VERY_RARE, Tex.GENSTARS, Check.ID_PNG, null, VotmSounds.SIGNAL_SIGGENUS4::get),
    SIGGENUS5("siggenus5", "unid_planet", Rarity.VERY_RARE, Tex.GENSTARS, Check.ID_PNG, null, VotmSounds.SIGNAL_SIGGENUS5::get),
    SIGGENUS6("siggenus6", "unid_planet", Rarity.VERY_RARE, Tex.GENSTARS, Check.ID_PNG, null, VotmSounds.SIGNAL_SIGGENUS6::get),
    SIGGENUS7("siggenus7", "unid_planet", Rarity.VERY_RARE, Tex.GENSTARS, Check.ID_PNG, null, VotmSounds.SIGNAL_SIGGENUS7::get),
    SIGGENUS8("siggenus8", "unid_planet", Rarity.VERY_RARE, Tex.GENSTARS, Check.ID_PNG, null, VotmSounds.SIGNAL_SIGGENUS8::get),
    FARD("fard", "planet_fard", Rarity.VERY_RARE, Tex.SHEET, Check.NOISE, null, VotmSounds.SIGNAL_FARD::get),
    TARDIS("tardis", "unid_object", Rarity.VERY_RARE, Tex.SHEET, Check.NOISE, "Geeronimoo!", VotmSounds.SIGNAL_TARDIS::get),
    LIFE_CRYSTAL("life_crystal", "unid_object", Rarity.VERY_RARE, Tex.SHEET, Check.NOISE, "W#ERE IS IT?\n#COME!SERVING\n#DIEFTHYNTIS! BORING.\nOH.AH #PAC# DUS#!\nCLOSE ONE! HELP..", VotmSounds.SIGNAL_LIFE_CRYSTAL::get),
    IRONLUNG("ironlung", "planet_ironlung", Rarity.VERY_RARE, Tex.SHEET, Check.NOISE, null, VotmSounds.IRONLUNGSIGNAL::get),
    FUNERAL("funeral", "unid_object", Rarity.VERY_RARE, Tex.GENSTARS, Check.UNIQUE, "...here..i..am...", VotmSounds.SIGNAL_FUNERAL::get) {
        @Override public void triggerEvent() { net.votmdevs.voicesofthemines.client.ClientInputHandler.funeralEventTimer = 1000; }
    },
    EVIL("evil", "unid_object", Rarity.VERY_RARE, Tex.STATIC_CAL, Check.UNIQUE, "....the end is near....", VotmSounds.SIGNAL_EVIL::get) {
        @Override public void triggerEvent() { net.votmdevs.voicesofthemines.client.ClientInputHandler.evilEventTimer = 100; }
    },
    PIZZABREATHER("pizzabreather", "unid_object", Rarity.VERY_RARE, Tex.SHEET, Check.UNIQUE, "process it\ncompletely...", VotmSounds.SIGNAL_PIZZABREATHER::get),
    PIRAMID("piramid", "unid_object", Rarity.VERY_RARE, Tex.SHEET, Check.NOISE, null, VotmSounds.SIGNAL_PIRAMID::get) {
