...
public class WashSpongeRenderer extends GeoEntityRenderer<WashSpongeEntity> {
    private static final ResourceLocation SELECT_ICON = new ResourceLocation(VoicesOfTheMines.MODID, "textures/gui/select.png");

    public WashSpongeRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new WashSpongeModel());
        this.shadowRadius = 0.1f;
    }

    @Override
    public void render(WashSpongeEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
